...
function css(config: ResolvedConfig): string {
  ...
  const callouts = `.manual-page h3:after{height:.32rem}.callout{background:var(--callout-background,#eef8f8)}.manual-key{min-height:1.45rem;padding:.16rem .42rem;border-color:#59636d;border-radius:.48rem;box-shadow:0 1px 1px #0006,inset 0 1px #ffffff24}.manual-shift-chord{display:inline-flex;align-items:flex-end;padding:.08rem .04rem 0}.manual-shift-chord .manual-key-shift{z-index:0;min-height:0;padding:.04rem .21rem;transform:translateY(.07rem)}.manual-shift-chord .manual-key-shift+.manual-key{z-index:1;margin-left:-.28rem;transform:translateY(-.08rem)}.manual-command-line{padding:.16rem .42rem;border:1px solid #aeb8c2;border-radius:.4rem;background:#4b5563;box-shadow:none}.manual-control-sequence{display:inline-flex;align-items:center;gap:0;margin:0 .08rem;padding:.16rem .24rem;border:1px solid #334554;border-radius:.5rem;background:var(--code);color:#f4f7f9;box-shadow:inset 0 1px #ffffff18,0 1px 2px #0004;font:700 .86em/1.35 ui-monospace,SFMono-Regular,Menlo,monospace;white-space:nowrap}.manual-control-sequence .manual-key{font-size:.9em}.manual-control-text{margin:0 .22rem}${Object.entries(t.callouts).map(([kind, color]) => `.callout-type-${kind}{--callout-color:${color}}`).join("")}`;
